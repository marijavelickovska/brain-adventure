...
| Progress | Feature is expected to show the user’s current question number out of a total of 15 questions. | Start the quiz and verify that the progress indicator updates correctly with each answered question (e.g., “Question 12 of 15”). | The progress is displayed correctly and updates with each question, accurately reflecting the current position out of 15. | ![screenshot](documentation/defensive/progress.png) |
...
![screenshot](documentation/issues/issues-opened.png)
